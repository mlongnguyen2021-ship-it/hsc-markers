#!/usr/bin/env python3
"""Search HSC Business Studies references and source Markdown with context."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Search HSC Business Studies references and source Markdown."
    )
...
def main() -> int:
    ...
    roots = [
        ...
        repo_root / "sources" / "business-studies",
    ]
