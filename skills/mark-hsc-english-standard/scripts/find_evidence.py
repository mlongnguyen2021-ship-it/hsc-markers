#!/usr/bin/env python3
"""Search HSC English Standard references and source Markdown with context."""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Search HSC English Standard references and source Markdown."
    )
    parser.add_argument("terms", nargs="+", help="Terms or phrases to search for")
    parser.add_argument(
        "--file", default="", help="Case-insensitive filename substring filter"
    )
    parser.add_argument(
        "--context", type=int, default=3, help="Lines before and after a hit"
    )
    parser.add_argument(
...
def main() -> int:
    ...
    roots = [skill_root / "references", repo_root / "sources" / "english-standard"]
